...
import { loadPlugins, pluginStore } from "./src/lib/patrick-plugins.js";
import { initDatabase, getDatabase } from "./src/lib/patrick-database.js";
import {
  initScheduler,
  loadScheduledMessages,
  startGroupScheduleChecker,
  startSewaChecker,
} from "./src/lib/patrick-scheduler.js";
import { handleAntiTagSW } from "./src/lib/patrick-group-protection.js";
import { initSholatScheduler } from "./src/lib/patrick-sholat-scheduler.js";
import { initNotifScheduler } from "./src/lib/patrick-notif-scheduler.js";
import { initAutoJpmScheduler } from "./src/lib/patrick-auto-jpm.js";
import { startMemoryMonitor } from "./src/lib/patrick-memory-monitor.js";
import { startTempCleaner } from "./src/lib/patrick-temp-cleaner.js";
import { startDailyPruner } from "./src/lib/patrick-data-pruner.js";
import {
  logger,
  c,
  playBootSequence,
  ...
  logErrorBox,
  divider,
} from "./src/lib/patrick-logger.js";

await import("./src/lib/patrick-agent.js")
    ...
    (eventType, filename) => {
      ...
      const timeout = setTimeout(async () => {
        ...
        if (!fs.existsSync(fullPath)) {
          ...
          const { unloadPlugin } = await import("./src/lib/patrick-plugins.js");
        ...
        try {
          ...
          const { hotReloadPlugin } =
            await import("./src/lib/patrick-plugins.js");
...
async function main() {
  await playBootSequence({
    name: config.bot?.name || "Patrick BOT",
      ...
      if (update.connection === "open") {
        ...
        try {
          const { startOtpPoller: _startOtp } =
            await import("./src/lib/patrick-otp-poller.js");
          _startOtp(sock);
        } catch {}

        try {
          const { getAllJadibotSessions, restartJadibotSession } =
            await import("./src/lib/patrick-jadibot-manager.js");
