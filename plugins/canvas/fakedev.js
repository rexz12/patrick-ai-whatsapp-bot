...
import { uploadTo0x0 } from "../../src/lib/patrick-tmpfiles.js";
...
async function handler(m, { sock }) {
  ...
  try {
    ...
    await sock.sendMedia(
      m.chat,
      `https://api.patrick.my.id/api/fake-developer-3?text=${encodeURIComponent(name)}&image=${gmbr.directUrl}&verified=true`,
      null,
      m,
      {
        type: "image",
