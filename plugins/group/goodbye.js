import {
  ...
  isLidConverted,
  lidToJid,
} from "../../src/lib/patrick-lid.js";
import moment from "moment-timezone";
import config from "../../config.js";
import { getDatabase } from "../../src/lib/patrick-database.js";
import { saluranCtx } from "../../src/lib/patrick-context.js";
import { createGoodbyeCard } from "../../src/lib/patrick-welcome-card.js";
import { resolveAnyLidToJid } from "../../src/lib/patrick-lid.js";
...
async function sendGoodbyeMessage(sock, groupJid, participant, groupMeta) {
  try {
    ...
    if (goodbyeType === 2) {
      ...
      await sock.sendMessage(groupJid, {
        video: getAssetBuffer("patrick-mp4") || { url: "https://files.catbox.moe/k28dhp.mp4" },
        gifPlayback: true,
        caption: text,
        contextInfo: {
          mentionedJid: [realParticipant],
