...
import { isLid, lidToJid } from '../../src/lib/patrick-lid.js'
import { checkPanelJeda, setPanelLastUsed } from '../../src/lib/patrick-panel-jeda.js'
import { hasAccessToServer, getUserRole, VALID_SERVERS } from '../../src/lib/patrick-roles-cpanel.js'
import { isGcSeller } from './gcseller.js'
import * as timeHelper from '../../src/lib/patrick-time.js'
import fs from 'fs'
const RAM_OPTIONS = [
  "1gb",
  "2gb",
...
async function handler(m, { sock }) {
  ...
  const email = `${username}@patrick.md`;
  ...
  try {
    ...
    await sock.sendMessage(targetUser, {
      image: getAssetBuffer("patrick-v8"),
      caption: detailTxt,
      contextInfo: {
