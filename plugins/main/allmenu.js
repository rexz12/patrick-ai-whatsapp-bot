...
import { generateWAMessageFromContent, prepareWAMessageMedia, proto } from "patrick";
...
import { getCasesByCategory, getCaseCount } from "../../case/patrick.js";
...
async function handler(m, { sock, config: botConfig, db, uptime }) {
  ...
  const imgUrl = getAssetBuffer("patrick");
  const thumbUrl = getAssetBuffer("patrick2");
