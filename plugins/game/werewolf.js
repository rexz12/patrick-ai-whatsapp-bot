...
try {
  ...
  if (fs.existsSync(path.join(assetsPath, "patrick-games.jpg"))) {
    thumbWW = fs.readFileSync(path.join(assetsPath, "patrick-games.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "patrick.jpg"))) {
    thumbNight = fs.readFileSync(path.join(assetsPath, "patrick.jpg"));
    thumbDay = fs.readFileSync(path.join(assetsPath, "patrick.jpg"));
  }
  if (fs.existsSync(path.join(assetsPath, "patrick-winner.jpg"))) {
    thumbWin = fs.readFileSync(path.join(assetsPath, "patrick-winner.jpg"));
  }
} catch (e) {
