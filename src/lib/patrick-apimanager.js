...
class OurinApiManager {
  ...
  makeProviders() {
    return {
      ...
      patrick: {
        baseURL: "https://api.patrick.my.id",
      },
    };
  }
...
const patrickApi = new OurinApiManager();

export { OurinApiManager, OurinApiProvider, patrickApi };
export default patrickApi;
