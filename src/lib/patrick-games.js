import {
  ...
  getRandomReward,
  getProgressiveHint,
} from "./patrick-game-data.js";
import { getDatabase } from "./patrick-database.js";
import { addExpWithLevelCheck } from "./patrick-level.js";
import {
  getGameContextInfo,
  sendGamePreview,
  checkFastAnswer,
} from "./patrick-context.js";
let fetchBuffer;
try {
  fetchBuffer = (await import("./patrick-utils.js")).fetchBuffer;
} catch {}
