import { downloadMediaMessage } from "patrick";
import { isLid, lidToJid, lidToJidSafe } from "./patrick-lid.js";
    ...
    try {
      ...
      if (msgContent) {
        ...
        if (
          ...
          const { downloadMediaMessage } = await import("patrick");
          const fakeMsg = {
            key: cached.key,
          ...
          const { generateWAMessageFromContent } = await import("patrick");
          const cleanContent = {};
