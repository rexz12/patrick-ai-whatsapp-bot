...
import { getDatabase } from "./patrick-database.js";
import { saluranCtx } from "./patrick-context.js";
import { getAssetBuffer } from "./patrick-asset-manager.js";
    ...
    if (replyVariant === 2) {
      ...
      return sock.sendMessage(
        m.chat,
        {
          ...
          jpegThumbnail: await sharp(getAssetBuffer("patrick2"))
            .resize(300, 300)
            .toBuffer(),
          caption: text,
          ...defaultOptions,
      ...
      const sss = getAssetBuffer("patrick3");
      return sock.sendMessage(
        m.chat,
        {
      ...
      const thumbnail = getAssetBuffer("patrick");
      ...
      return sock.sendPreview(
        m.chat,
        {
          ...
          title: config.bot?.name || "Patrick AI",
          description:
        ...
        },
        {
          ...
          contextInfo: {
            ...
            forwardedNewsletterMessageInfo: {
              ...
              newsletterName: config.saluran?.name || config.bot?.name || "Patrick AI",
