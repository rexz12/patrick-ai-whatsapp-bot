// Ohh iya, buat kalian yang mau ngedukung script patrick lebih
...
import * as ownerPremiumDb from "./src/lib/patrick-premium-db.js";

//  utamakan baca object config sampai bawah
const config = {
  info: {
    website: "",
    grupwa: "https://chat.whatsapp.com/BaqzBw8E05KEqmF3CxOrwQ",
  },

  owner: {
    name: "Reza", // Nama owner
    number: ["628xxx"], // Format: 628xxx (tanpa + atau 0)
  },

  session: {
    pairingNumber: "628xxx", // Nomor WA yang akan di-pair, ini penting
    usePairingCode: true, // true = Pairing Code, false = QR Code
  },

  bot: {
    name: "𝗣𝗔𝗧𝗥𝗜𝗖𝗞 𝗔𝗜", // Nama bot
    version: "3", // Versi bot
    developer: "RezaDev", // Nama developer
  },
  ...
  assets: {
"patrick-allmenu": "./assets/image/patrick-allmenu.jpg",
    "patrick-daftar": "./assets/image/patrick-daftar.png",
    "patrick-demote": "./assets/image/patrick-demote.png",
    "patrick-fishit": "./assets/image/patrick-fishit.jpg",
    "patrick-games": "./assets/image/patrick-games.jpg",
    "patrick-landscape": "./assets/image/patrick-landscape.jpg",
    "patrick-levelup": "./assets/image/patrick-levelup.jpg",
    "patrick-minecraft": "./assets/image/patrick-minecraft.jpg",
    "patrick-promote": "./assets/image/patrick-promote.png",
    "patrick-rpg": "./assets/image/patrick-rpg.jpg",
    "patrick-rules": "./assets/image/patrick-rules.jpg",
    "patrick-store": "./assets/image/patrick-store.png",
    "patrick-v11": "./assets/image/patrick-v11.jpg",
    "patrick-v7": "./assets/image/patrick-v7.jpg",
    "patrick-v8": "./assets/image/patrick-v8.jpg",
    "patrick-v9": "./assets/image/patrick-v9.jpg",
    "patrick-winner": "./assets/image/patrick-winner.jpg",
    "patrick": "./assets/image/patrick.jpg",
    "patrick2": "./assets/image/patrick2.jpg",
    "patrick3": "./assets/image/patrick3.jpg",
    "pp-kosong": "./assets/image/pp-kosong.jpg",
    "reza": "./assets/image/reza.jpg",
    "patrick-mp4": "./assets/video/patrick-mp4.mp4",
    "patrick-mp3": "./assets/audio/patrick-mp3.mp3",
    "patrick-otp": "./assets/image/patrick-otp.jpg",
    "patrick-font": "./assets/patrick-font.ttf",
    "patrick-kertas": "./assets/image/patrick-kertas.jpg",
  ...
  donasi: {
    payment: [
      { name: "Dana", number: "08xxxxxxxxxx", holder: "Reza Store" },
  ...
  sticker: {
    packname: "𝗣𝗔𝗧𝗥𝗜𝗖𝗞 𝗔𝗜", // Nama pack sticker
    author: "Reza", // Author sticker
  },

  saluran: {
    id: "120363408612196769@newsletter", // ID saluran (contoh: 120363xxx@newsletter)                          // ID saluran (contoh: 120363xxx@newsletter)
    name: "Patrick AI", // Nama saluran
    link: "https://whatsapp.com/channel/0029VbDHOhsJkK73UDWrrx3Q", // Link saluran
  },
...
- Jangan mengaku sebagai AI atau bot.`,
  ...
  APIkey: {
    ...
    google: "F4oDUF-https://api.neoxr.eu/api",
